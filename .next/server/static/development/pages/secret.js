...
class Secret extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onPingCall", async e => {
      const token = cookies.get('token');

      try {
        const res = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(serverUrl + '/api/ping', {
          headers: {
            'Authorization': token
          }
        });
...
Secret.getInitialProps = async ctx => {
  ...
  await Object(_utils_auth__WEBPACK_IMPORTED_MODULE_4__["handleAuthSSR"])(ctx); // Must return an object
...
async function handleAuthSSR(ctx) {
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(serverUrl + "/api/token/ping", {
      headers: {
        'Authorization': token
      }
    });
...
module.exports = __webpack_require__(/*! C:\Users\Roglol\Desktop\dekori\pages\secret.js */"./pages/secret.js");
